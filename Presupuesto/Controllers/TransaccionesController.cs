...
namespace Presupuesto.Controllers
{
    public class TransaccionesController : Controller
    {
        ...
        public async Task<FileResult> ExportarExcelTodo()
        {
            ...
            var nombreArchivo = $"Presupuesto - {fechaInicio.AddYears(100).ToString("dd-MM-yyyy")}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        }
        ...
        public async Task<JsonResult> ObtenerTransacionesPorFecha(DateTime fecha)
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
        ...
        public async Task<IActionResult> Editar(int id, string urlRetorno = null)
        {
            ...
            modelo.MontoAnterior = modelo.MontoAnterior;
        ...
        private async Task<IEnumerable<SelectListItem>> ObtenerCategorias(int usuarioId, TipoOperacion tipoOperacion)
        {
            ...
            var opcionPorDefecto = new SelectListItem(" - Seleccionar -","0", true);
